...
\hypersetup{
  pdftitle={R作业2},
  pdfauthor={laijr-2024311265},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{R作业2}
\author{laijr-2024311265}
\date{2026/4/16}

\begin{document}
\maketitle

算法编程 题目1:离散分布随机数生成与频率比较
...
\pandocbounded{\includegraphics[keepaspectratio]{1_files/1_files/figure-latex/q1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{1_files/1_files/figure-latex/q2-1.pdf}}
...
\StringTok{"前5次抽样结果(各取前3个编号):}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{);}\FunctionTok{print}\NormalTok{(results[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{cat}\NormalTok{(}\StringTok{"各层平均被抽频率:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{);}\FunctionTok{print}\NormalTok{(}\FunctionTok{round}\NormalTok{(}\FunctionTok{rowMeans}\NormalTok{(layer\_freq) }\SpecialCharTok{/}\NormalTok{ m, }\DecValTok{3}\NormalTok{));}\FunctionTok{cat}\NormalTok{(}
\StringTok{"理论各层抽取比例:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, N\_strata }\SpecialCharTok{/}\NormalTok{ N\_total, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{"真实值 lambda=3}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
\StringTok{"估计均值:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(lambda\_ests), }\DecValTok{4}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
\StringTok{"估计标准差:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{sd}\NormalTok{(lambda\_ests), }\DecValTok{4}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
\StringTok{"理论标准误 sqrt(lambda/n):"}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{sqrt}\NormalTok{(lambda\_true}\SpecialCharTok{/}\NormalTok{n4), }\DecValTok{4}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
\StringTok{"=== 方差估计(S\^{}2)===}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
\StringTok{"真实值 Var(X)=lambda=3}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
\StringTok{"估计均值:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(var\_ests), }\DecValTok{4}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}
\NormalTok{,}\StringTok{"估计标准差:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{sd}\NormalTok{(var\_ests), }\DecValTok{4}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{1_files/1_files/figure-latex/q4-1.pdf}}
...
\StringTok{"均值:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(mom\_ests), }\DecValTok{4}\NormalTok{),}
...
\StringTok{" MSE:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(mse\_mom, }\DecValTok{6}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n\textbackslash{}n}\StringTok{"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{"均值:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(mle\_ests), }\DecValTok{4}\NormalTok{),}
...
\StringTok{" MSE:"}\NormalTok{, }\FunctionTok{round}\NormalTok{(mse\_mle, }\DecValTok{6}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"MSE之比 (MOM/MLE):"}\NormalTok{, }\FunctionTok{round}\NormalTok{(mse\_mom}\SpecialCharTok{/}\NormalTok{mse\_mle, }\DecValTok{4}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
题目6:线性模型 \(Y = \alpha + \beta*X + \epsilon,\alpha=2,\beta=1.5\) X
\textasciitilde{} U(0,1),\(\epsilon\) \textasciitilde{}
N(0,1),500组样本,OLS估计
...
\StringTok{"OLS估计:alpha\_hat="}\NormalTok{, }\FunctionTok{round}\NormalTok{(alpha\_hat, }\DecValTok{4}\NormalTok{),}
\StringTok{" beta\_hat="}\NormalTok{, }\FunctionTok{round}\NormalTok{(beta\_hat, }\DecValTok{4}\NormalTok{), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{plot}\NormalTok{(X, Y, }\AttributeTok{pch =} \StringTok{"."}\NormalTok{, }\AttributeTok{col =} \StringTok{"gray50"}\NormalTok{,}
     \AttributeTok{main =} \StringTok{"Linear OLS (n=500)"}\NormalTok{,}
...
\FunctionTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{,}
       \AttributeTok{legend =} \FunctionTok{c}\NormalTok{(}\StringTok{"Real Line"}\NormalTok{, }\StringTok{"OLS Estimate"}\NormalTok{),}
...
\pandocbounded{\includegraphics[keepaspectratio]{1_files/1_files/figure-latex/q6-1.pdf}}
...
\NormalTok{X }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\FloatTok{2.5}\NormalTok{, }\FloatTok{3.5}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{6}\NormalTok{)}
\NormalTok{prob }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\FloatTok{0.2}\NormalTok{, }\FloatTok{0.3}\NormalTok{, }\FloatTok{0.2}\NormalTok{, }\FloatTok{0.2}\NormalTok{)}
\NormalTok{Fx }\OtherTok{\textless{}{-}} \FunctionTok{cumsum}\NormalTok{(prob)}
\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{1000}
\NormalTok{xi }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
...
\NormalTok{  xi[i] }\OtherTok{\textless{}{-}}\NormalTok{ X[}\FunctionTok{which}\NormalTok{(u }\SpecialCharTok{\textless{}=}\NormalTok{ Fx)[}\DecValTok{1}\NormalTok{]]}
\NormalTok{\}}
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(X, }\AttributeTok{size =}\NormalTok{ n, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{prob =}\NormalTok{ prob)}
\CommentTok{\#逆变换法生成的随机数频率}
\FunctionTok{table}\NormalTok{(xi)}\SpecialCharTok{/}\NormalTok{n}
\end{Highlighting}
\end{Shaded}
...
## xi
##     1   2.5   3.5     5     6 
## 0.097 0.195 0.293 0.213 0.202
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#直接使用sample()函数生成随机数频率}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 使用条件分布法产生二元正态分布向量}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{214}\NormalTok{)}

\CommentTok{\# 参数设置}
\NormalTok{mu }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{)}
\NormalTok{sigma11 }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{sigma22 }\OtherTok{\textless{}{-}} \DecValTok{2}  \CommentTok{\# 假设 var(X2) = 2}
\NormalTok{rho }\OtherTok{\textless{}{-}} \FloatTok{0.8}
\NormalTok{sigma12 }\OtherTok{\textless{}{-}}\NormalTok{ rho }\SpecialCharTok{*} \FunctionTok{sqrt}\NormalTok{(sigma11 }\SpecialCharTok{*}\NormalTok{ sigma22)  }\CommentTok{\# 协方差}
\NormalTok{Sigma }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{c}\NormalTok{(sigma11, sigma12, sigma12, sigma22), }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{)}

\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{1000}

\CommentTok{\# 条件分布法}
\NormalTok{X1 }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(n, }\AttributeTok{mean =}\NormalTok{ mu[}\DecValTok{1}\NormalTok{], }\AttributeTok{sd =} \FunctionTok{sqrt}\NormalTok{(sigma11))}
\NormalTok{mu2\_cond }\OtherTok{\textless{}{-}}\NormalTok{ mu[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ sigma12 }\SpecialCharTok{/}\NormalTok{ sigma11 }\SpecialCharTok{*}\NormalTok{ (X1 }\SpecialCharTok{{-}}\NormalTok{ mu[}\DecValTok{1}\NormalTok{])}
\NormalTok{sigma2\_cond }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(sigma22 }\SpecialCharTok{{-}}\NormalTok{ sigma12}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/}\NormalTok{ sigma11)}
\NormalTok{X2 }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(n, }\AttributeTok{mean =}\NormalTok{ mu2\_cond, }\AttributeTok{sd =}\NormalTok{ sigma2\_cond)}
\NormalTok{X }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(X1, X2)}

\CommentTok{\# 验证均值和协方差}
\FunctionTok{cat}\NormalTok{(}\StringTok{"样本均值:"}\NormalTok{, }\FunctionTok{colMeans}\NormalTok{(X), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
\StringTok{"样本协方差矩阵:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{);}\FunctionTok{print}\NormalTok{(}\FunctionTok{cov}\NormalTok{(X));}\FunctionTok{cat}\NormalTok{(}\StringTok{"理论协方差矩阵:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{);}\FunctionTok{print}\NormalTok{(Sigma)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## 样本均值: -0.002348357 -0.001774765 
##  样本协方差矩阵:
\end{verbatim}

\begin{verbatim}
##           X1       X2
## X1 0.9752941 1.120274
## X2 1.1202738 1.973888
\end{verbatim}
...
\begin{Highlighting}[]
\CommentTok{\# 散点图}
\FunctionTok{plot}\NormalTok{(X, }\AttributeTok{pch =} \StringTok{"."}\NormalTok{, }\AttributeTok{col =} \StringTok{"steelblue"}\NormalTok{,}
     \AttributeTok{main =} \StringTok{"Bivariate Normal (Conditional Method)"}\NormalTok{,}
     \AttributeTok{xlab =} \StringTok{"X1"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"X2"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{1_files/1_files/figure-latex/2.1.4-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{1_files/1_files/figure-latex/iris_plot-1.pdf}}
...
\FunctionTok{hist}\NormalTok{(x,}
     \AttributeTok{main  =} \StringTok{"Uniform(0,10) Distribution"}\NormalTok{,}
...
\pandocbounded{\includegraphics[keepaspectratio]{1_files/1_files/figure-latex/unnamed-chunk-1-1.pdf}}
